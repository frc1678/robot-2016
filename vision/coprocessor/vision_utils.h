...
const std::vector<int> colorspaces = {CV_BGR2HLS, CV_BGR2HSV, CV_BGR2Lab,
                                      CV_BGR2Luv, CV_BGR2RGB, CV_BGR2YCrCb,
                                      CV_BGR2YUV};

const std::vector<std::string> colorNames = {"HLS", "HVS",   "Lab", "Luv",
                                             "RGB", "YCrCb", "YUV"};
}
